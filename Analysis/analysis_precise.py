...
all_path = ["object1_normal.pkl", "object2_normal.pkl", "object3_normal.pkl"]
# all_path = ["object1_district.pkl", "object2_district.pkl", "object3_district.pkl"]
...
for path in all_path:
        ...
        file_path = f"{begin_path}/results/texts_results/object_normal.txt"
        # file_path = f"{begin_path}/results/texts_results/object_district.txt"

        if os.path.exists(file_path):
                print("The file already exists.")
                resultFile = open(f"{begin_path}/results/texts_results/object_normal.txt", "a+")
                # resultFile = open(f"{begin_path}/results/texts_results/object_district.txt", "a+")
        else:
                print("The file does not exist.")
                resultFile = open(f"{begin_path}/results/texts_results/object_normal.txt", "w+") 
                # resultFile = open(f"{begin_path}/results/texts_results/object_district.txt", "w+") 
        ...
        listofarr = []
        print(f"file:{path}")
        df = pd.read_pickle(f"{begin_path}/pkl/object/{path}").reset_index()
        ...
        # features= df.drop(columns=['target', 'group', 'layers'])
        features= df.drop(columns=['target', 'group'])
