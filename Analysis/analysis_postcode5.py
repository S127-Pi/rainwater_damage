...
all_path = ["postcode5_1_normal.pkl", "postcode5_2_normal.pkl", "postcode5_3_normal.pkl"]
# all_path = ["postcode5_1_district.pkl", "postcode5_2_district.pkl", "postcode5_3_district.pkl"]

for path in all_path:
        begin_path = os.getcwd()
        resultFolder = f"{begin_path}"

        file_path = f"{begin_path}/results/texts_results/postcode5_normal.txt"
        # file_path = f"{begin_path}/results/texts_results/postcode5_district.txt"

        if os.path.exists(file_path):
                print("The file already exists.")
                resultFile = open(f"{begin_path}/results/texts_results/postcode5_normal.txt", "a+")
                # resultFile = open(f"{begin_path}/results/texts_results/postcode5_district.txt", "a+")
        else:
                print("The file does not exist.")
                resultFile = open(f"{begin_path}/results/texts_results/postcode5_normal.txt", "w+") 
                # resultFile = open(f"{begin_path}/results/texts_results/postcode5_district.txt", "w+") 
        ...
        print(f"file:{path}")
        df = pd.read_pickle(f"{begin_path}/pkl/postalcode5/{path}").reset_index()
